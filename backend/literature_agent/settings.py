...
MIDDLEWARE = [
    "research.middleware.SimpleCorsMiddleware",
...
ROOT_URLCONF = "literature_agent.urls"
...
WSGI_APPLICATION = "literature_agent.wsgi.application"

if os.getenv("DB_ENGINE", "").lower() == "mysql":
    DATABASES = {
        "default": {
            "ENGINE": "django.db.backends.mysql",
            "NAME": os.getenv("MYSQL_DATABASE", "literature_agent"),
